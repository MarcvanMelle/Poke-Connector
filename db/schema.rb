...
ActiveRecord::Schema.define(version: 20161020150138) do
  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "active_pokeballs", force: :cascade do |t|
    t.integer  "user_id",     null: false
    t.integer  "pokeball_id", null: false
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["pokeball_id"], name: "index_active_pokeballs_on_pokeball_id", using: :btree
    t.index ["user_id"], name: "index_active_pokeballs_on_user_id", using: :btree
  end
  ...
  create_table "active_requests", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["request_id"], name: "index_active_requests_on_request_id", using: :btree
    t.index ["user_id"], name: "index_active_requests_on_user_id", using: :btree
  end
